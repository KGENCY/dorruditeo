        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-duru-ivory rounded-2xl p-10 border border-gray-100">
              ...
              <button className="w-full py-4 text-lg bg-white border border-duru-orange-200 text-duru-orange-600 font-bold rounded hover:bg-duru-orange-50 transition-colors">
                구직자 서비스 바로가기
              </button>
            </div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 text-base">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
            <p>© 2024 Duru-bit-teo. All rights reserved.</p>
